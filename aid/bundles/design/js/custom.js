...
jQuery(document).ready(function(){
	...
	$('.addtocart').hover(function(){
		$(this).css({'background': 'transparent', 'border': '1px solid #00c0ef'});
		$(this).children('i').css('color', '#00c0ef');
		$(this).children('span').css('color', '#00c0ef');
	}, function(){
		$(this).css({'background': '#00c0ef', 'border': 'unset'});
		$(this).children('i').css('color', '#fff');
		$(this).children('span').css('color', '#fff');
	});
	
	$('.wishlist').hover(function(){
		$(this).css({'background': 'transparent', 'border': '1px solid #2b2b2b'});
		$(this).children('i').css('color', '#2b2b2b');
	}, function(){
		$(this).css({'background': '#2b2b2b', 'border': 'unset'});
		$(this).children('i').css('color', '#fff');
	});
